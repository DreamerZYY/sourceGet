...
window.onload=function(){
	...
	$("#top li:eq(" + clientIndex + ")").click();//页面加载时，若没有进行其他的选择，默认的给第一条数据设置样式，使其获得焦点
...
function pptStr(hrefDownLoad1, href1){
    return '<ul><li><img src="../images/contentTab/shouye.png" class="headPage" onclick="docmd(\'keycode\',\'urlplayer%20-keyevent%200xFF50\')"/></li><li><img src="../images/contentTab/weiye.png" class="endPage" onclick="docmd(\'keycode\',\'urlplayer%20-keyevent%200xFF57\')" ></li><li><a id="downLoad" class="downFile" href="' + hrefDownLoad1 + '"><img src="../images/contentTab/xiazai.png" class="downLoad"/></a></li><li><a id="checkFile" class="downFile" href1="' + href1 + '"><img src="../images/contentTab/yulan.png" class="checkIn"  onclick="checkFile(this)" /></a></li></ul>';
...
function videoStr(hrefDownLoad1, href1){
	return '<ul><li><img src="../images/contentTab/yinliang.png" class="materialSound soundNum" onclick="meterialSound(this);"/></li><li><img src="../images/contentTab/danru.png" class="soundIn" onclick="docmd(3041,0);" ><li><img src="../images/contentTab/danchu.png" class="soundOut" onclick="docmd(3041,254);"></li><li><img src="../images/contentTab/kongzhi.png" class="controlLab" onclick="docmd(3008,0);" /></li><li><a id="downLoad" class="downFile" href="'+hrefDownLoad1+'"><img src="../images/contentTab/xiazai.png" class="downLoad"/></a></li><li><a id="checkFile" class="downFile" href1="'+href1+'"><img src="../images/contentTab/yulan.png" class="checkIn"  onclick="checkFile(this)" /></a></li></ul><div id="meterial"><input id="range2" type="range" min="0" max="255" value="0" onchange="change(\'range2\',\'value2\')"><span id="value2">5</span></div>';
...
function change(range1,value1) {
   if(range1=="range"){
	   ...
	   docmd(nw * 10000 +29,getSoundNumSlip(document.getElementById(range1).value));
   }else{
	   var value2 = document.getElementById('range2').value ;
	   document.getElementById(value1).innerHTML = value2;
	   docmd(nw * 10000 +3001,getSoundNumSlip(document.getElementById(range1).value));
   }
...
function powerOff(){
    ...
    if ($(".topConfirm").attr("messageTip") == "ok") {
        ...
        $.ajax({
            url: errorURL + "/wpsendclientmsg.asp?wpsendclientmsg=0_1000&rnd=" + (Math.floor(Math.random() * (9999 - 1000)) + 1000),
            dataType: 'xml',
            type: 'GET',
            success: function (data) {
